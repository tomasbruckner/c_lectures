...
V kapitole XXX jsme se setkali s aritmetickými operacemi. Nyní si ukážeme jejich zkrácený zápis, který funguje stejně jako klasický zápis (jenom je napsaný kratším zápisem)
...
Zkrácený zápis můžeme použít i pro bitové operace (viz kapitola XXX)
